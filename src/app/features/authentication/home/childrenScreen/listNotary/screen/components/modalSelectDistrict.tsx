...
interface ModalSelectProps {
    ...
    onHideModal: () => void;
    selectItem: any;
    itemDistrict: Array<any>,
    setSelectNameDistrict: Array<any>,
    setParentIdDistrict: string
}
export const ModalSelectDistricts = ({ onPress, onHideModal, visible, selectItem,itemDistrict,setSelectNameDistrict,setParentIdDistrict}: ModalSelectProps) => {
    const onClickButton = (item: any) => {
        onPress && onPress(item);
        setSelectNameDistrict(item.title),
        setParentIdDistrict(item.id)
    }
