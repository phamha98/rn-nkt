...
interface ModalSelectProps {
    ...
    setSelectNameCity:string
}
export const ModalSelectAddress = ({ onPress, onHideModal, visible, selectItem,itemAddress,setParentid,setSelectNameCity }: ModalSelectProps) => {
